...
export default {
  ...
  form: {
    ...
    modsXml: 'MODS-XML',
    modsXmlHint: 'Laden Sie hier die MODS-XML (Metadata Object Description Schema) hoch.',
    reset: 'Zurücksetzen',
    submit: 'Transformieren',
    validation: {
      required: 'Das Feld ist verpflichtend.',
    },
  },
  subtitle: 'Tranformieren Sie eine MODS-XML (Metadata Object Description Schema) zu eine OPUS-XML',
  title: 'HSDopus Import',
  transformation: {
